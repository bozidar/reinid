...
<link rel="shortcut icon"
	href="${resource(dir:'images',file:'favicon2.ico')}"
	type="image/x-icon" />
<script type="text/javascript"
	src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.3/jquery.js"></script>
<script type="text/javascript"
...
<div id="banner"><a href="#"><img
	src="${resource(dir:'images',file:'homepage03.jpg')}" width="637"
	height="142" alt="" /></a></div>
</div>
<div id="menu-content">
<div id="menu">
<ul>
	<li class="first"><g:link controller="home">Home</g:link></li>
